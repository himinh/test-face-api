...
export class ShareFunction {
  ...
  public static getAccessToken() {
    ...
    const token =
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2M2Y1ODgyNTkwZWZhMzRiNTc4NDk0YjciLCJyb2xlIjoibWFuYWdlciIsImlhdCI6MTY3ODg2Mjk5MywiZXhwIjoxNzEwMzk4OTkzfQ.vkj2NYXLtMV2hS3UtGeDVc7Gff7cfe3d6dTgtqMvBBw';

    return this.env().ACCESS_TOKEN_SOCKET || token;
  }
