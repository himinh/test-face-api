...
import UpdateA3FeedbackDto from './dto/update-a3-feedback.dto';

@ApiTags('A3Feedbacks')
@UseInterceptors(WrapResponseInterceptor)
@Controller()
export default class A3FeedbackController {
  constructor(private readonly feedbackService: A3FeedbackService) {}
  ...
  async findAll(@Query() query: any): Promise<any> {
    const result = await this.feedbackService.findManyBy(query);
    return result;
  }
  ...
  async findOneBy(
    ...
    return this.feedbackService.findOneBy(filter, {
      filter,
      projection,
    });
  }
  ...
  async findOneById(
    ...
    const result = await this.feedbackService.findOneById(id, { populate });
